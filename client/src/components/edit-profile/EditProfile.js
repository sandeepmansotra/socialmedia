            ...
            <div className="col-md-8 m-auto">
              ...
              <form onSubmit={this.onSubmit}>
                <TextFieldGroup
                  ...
                  onChange={this.onChange}
                  error={errors.handle}
                  info="Please provide a unique handle"
                />
                <SelectListGroup
                  name="status"
                  ...
                  error={errors.status}
                  options={options}
                  info="Please specify your designation"
                />
                <TextFieldGroup
                  placeholder="Company"
                  name="company"
                  ...
                  info="Mention your current company."
                />
                <TextFieldGroup
                  placeholder="Website"
                  name="website"
                  ...
                  info="Please provide your website URL."
                />
                <TextFieldGroup
                  ...
                  info="Please enter your current location."
                />
                <TextFieldGroup
                  placeholder="* Skills"
                  name="skills"
                  ...
                  onChange={this.onChange}
                  error={errors.skills}
                  info=" Use comma to separated values like (PHP, CSS, HTML)"
                />
                <TextFieldGroup
                  ...
                  info="Add GitHub username to show latest GitHub repos."
                />
                <TextAreaField
                  ...
                  onChange={this.onChange}
                  error={errors.bio}
                  info="Type somthing about yourself."
                />
                <div className="mb-3">
                  <button
                    type="button"
